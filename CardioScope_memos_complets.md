...
- FEVG 40–50% **ou** FEVG > 50% avec ≥ 1 critère échocardiographique (e/e' ≥ 11, VOG indexé ≥ 34 mL/m², masse VG ind. ≥ 115/95 g/m²)
- BMI 27–50 (ou < 27 si + DT2 ou analogue GLP-1, ou tour de taille > 94/80 cm)
- Nt-proBNP élevé (en RS > 150 pg/mL si BMI > 30 / > 300 si BMI < 30 ; en FA > 300 si BMI > 30 / > 600 si BMI < 30) **ou** hospitalisation avec furosémide IV dans les 12 mois
- Traité par gliflozine — Âge 18–80 ans
...
- HTP groupe 2 documentée au cathétérisme droit (screening pouvant aller jusqu'à 4 mois après KTD) :
  - PAPO ≥ 18 mmHg + PAPm ≥ 30 mmHg + POD ≥ 8 mmHg **(au repos)**
  - ou PAPO ≥ 20 + PAPm ≥ 32 + POD ≥ 8 mmHg **(lever de jambe passif)**
  - ou PAPO ≥ 25 + PAPm ≥ 35 + POD ≥ 10 mmHg **(à l'effort)**

📞 Karine MAUGENDRE — DECT 65741 — karine.maugendre@chu-nantes.fr
...
- **≥ 1 critère parmi :**
  - Épisode d'IC documenté dans les 12 derniers mois **ou**
  - NYHA ≥ 2 + critère d'enrichissement (Nt-proBNP > 400, critères ETT, diurétiques…)
...
- NYHA 2–4 et BMI > 30
- Nt-proBNP > 150 pg/mL (ou > 100 si BMI > 35) en RS / > 300 (ou > 200 si BMI > 35) en FA
- **≥ 1 parmi :** DFG 15–60 ou RAC > 30 mg/g ou hospitalisation pour IC < 12 mois

📞 Audrey ERNOULD — DECT 82726

---

### 🔬 ARCADIA — Insuffisance cardiaque avancée

📌 Évaluation de l'**atteinte cardio-rénale sous dapagliflozine** chez des patients en liste d'attente de transplantation cardiaque ou bilan pronostique (Cohorte prospective)

✅ **Principaux critères d'inclusion**
- NYHA > 3 et FEVG < 35%
- Sous traitement optimal incluant **dapagliflozine** (empagliflozine non éligible)
- Inscrit sur liste de greffe avec accès à la transplantation > 6 mois **ou** en parcours pré-greffe (bilan pronostique)

📞 Emilie BOURGEON CONAN — DECT 72003
...
### 🔬 TRITON (ALN-TTRSC04) — ARN interférent de 4e génération (silencer TTR)

📌 **Nucrésiran** (silencer par ARN interférent, 300 mg SC / 6 mois) vs placebo dans l'amylose cardiaque ATTR

✅ **Principaux critères d'inclusion**
- Amylose ATTR (wildtype ou héréditaire) — âge ≤ 85 ans
- Nt-proBNP entre **300 et 8 500 pg/mL** en RS (ou 600–8 500 en FA)
- ATCD d'IC : ≥ 1 hospitalisation pour IC **ou** traitement diurétique stable > 1 mois
- Pouvant recevoir un stabilisateur (tafamidis/acoramidis)
- Cliniquement stable (pas d'hospitalisation CV dans les 6 dernières semaines)
...
### 🔬 CLEOPATTRA (Novo Nordisk) — Anticorps déplétteur de TTR

📌 **Anticorps déplétteur** (NNC6019-000, perfusion IV mensuelle) vs placebo dans l'amylose ATTR

✅ **Principaux critères d'inclusion**
- Amylose ATTRwt ou ATTRv — pas de limite d'âge
- NYHA 1–4 sous diurétique de l'anse + **≥ 1 parmi :**
  - ATCD de décompensation cardiaque
  - Congestion clinique (crépitants, œdèmes des membres inférieurs…)
- **Nt-proBNP ≥ 1 000 pg/mL** au screening
- Traitement médical stabilisé depuis ≥ 1 mois
...
### 🔬 FORTITUDE — CMH non obstructive

📌 **Ninerafaxstat 200 mg x2/j vs placebo pendant 12 semaines** dans la CMH non obstructive symptomatique

✅ **Principaux critères d'inclusion**
- CMH non obstructive : gradient < 30 mmHg au repos et à la manœuvre de Valsalva, épaisseur ≥ 15 mm (ou ≥ 13 mm si apparenté ou mutation identifiée)
- Symptomatique NYHA 2–3 et FEVG > 55%
- Nt-proBNP ≥ 125 pg/mL (≥ 300 si FA)

📞 Sophie CLÉRO — DECT 68654 — sophie.clero@chu-nantes.fr

---

### 🔬 REMY — Registre SFC des CMH

📌 Registre national SFC en soins courants — Suivi des patients CMH, avec focus particulier sur les patients sous **nouvelles thérapeutiques** (mavacamten/camizestrant, ninerafaxstat…)

✅ **Critère d'inclusion**
- Toute **CMH sarcomérique** (en particulier patients sous nouvelles thérapeutiques)
...
- **Rythme sinusal**
- **Strain OG réservoir ≤ 20%** (en conditions normales, hors congestion ou HTA non contrôlée)
...
### 🔬 EPIC-VT — Ablation TV endo vs endo-épicardique sur cardiopathie ischémique

📌 **Ablation endocardique vs endo-épicardique** des tachycardies ventriculaires sur cardiopathie ischémique (Randomisée, multicentrique)

✅ **Principaux critères d'inclusion**
- 1ère ablation par radiofréquence d'une **TV sur cardiopathie ischémique**
- Porteur d'un DAI avec télésurveillance active
...
- Pas d'indication formelle à un PM pour autre raison
...
### 🔬 RESOUDRE — Registre mort subite du sportif jeune

📌 Registre prospectif national — **Morts subites chez les sportifs de 12 à 35 ans** (Observationnelle, non-opposition)

✅ **Principaux critères d'inclusion**
- 12–35 ans, sans pathologie cardiovasculaire connue
- ACR brutal non traumatique **pendant ou dans l'heure suivant une pratique sportive**
...
## 🟠 USIC / HÉMODYNAMIQUE / TRANSVERSAL
...
### 🔬 VICTORION Rides — Inclisiran précoce post-SCA

📌 **Inclisiran vs placebo** introduit précocement après revascularisation pour SCA (Phase III, double aveugle)

✅ **Principaux critères d'inclusion**
- Patient majeur hospitalisé pour **SCA athéromateux** (ST+ ou ST-)
- Inclusion le lendemain de la revascularisation, avec LDL-C :
  - ≥ 0,7 g/L sous statine haute intensité depuis ≥ 4 semaines
  - ≥ 1 g/L sous statine faible intensité depuis ≥ 4 semaines
  - ≥ 1,25 g/L sans statine depuis ≥ 4 semaines

📞 Léa FONTENEAU — DECT 82740 — lea.fonteneau@chu-nantes.fr

---

### 🔬 ZENITH — Zilbésiran dans l'HTA résistante à haut risque CV

📌 **Zilbésiran vs placebo** pour réduire les événements CV majeurs chez les patients hypertendus non contrôlés à haut risque (Phase III, double aveugle)

✅ **Principaux critères d'inclusion**
- Sous **≥ 2 anti-HTA dont un diurétique**, avec PAS ≥ 145 mmHg en consultation
- Âge ≥ 55 ans à haut risque CV **ou** âge ≥ 18 ans avec maladie CV avérée
- Haut risque CV : ≥ 2 facteurs parmi : âge ≥ 70 ans, DFGe < 60, albumine/créat > 300, tabagisme actif, FA traitée, CAC > 100, NT-proBNP > 125, DT2 ou IMC ≥ 30
